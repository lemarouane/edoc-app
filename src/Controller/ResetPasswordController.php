...
class ResetPasswordController extends AbstractController
{
    ...
    {
        $user = $this->entityManager->getRepository(Etudiants::class)->findOneBy([
            'email' => $emailFormData,
        ]);
        ...
        if($user!=null){
            ...
            $subject =  'Password Reset Request on ENSAT E-DOC';
        
            if($user_lang =='fr-FR'){
                $subject =  'Demande de Réinitialisation de Mot de Passe sur ENSAT E-DOC';
            }
            if($user_lang =='ar-AR'){
                $subject =  'ENSAT E-DOC طلب إعادة تعيين كلمة المرور على ';
            }
            if($user_lang =='es-ES'){
                $subject =  'Solicitud de Restablecimiento de Contraseña en ENSAT E-DOC';
            }
            if($user_lang =='en-GB'){
                $subject =  'Password Reset Request on ENSAT E-DOC';
            }
